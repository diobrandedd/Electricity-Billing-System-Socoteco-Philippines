...
<head>
    ...
    <title>Management Team - SOCOTECO II</title>
    ...
    <section class="hero-section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="display-4 fw-bold mb-4">Management Team</h1>
                    <p class="lead mb-4">Our experienced leaders driving SOCOTECO II forward.</p>
                </div>
                <div class="col-lg-4 text-center">
                    <i class="fas fa-user-tie" style="font-size: 8rem; opacity: 0.3;"></i>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h3 class="card-title mb-0"><i class="fas fa-user-tie me-2"></i>Management Team</h3>
                </div>
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-12">
                            <p class="lead">The Management Team information will be updated with the official details from the SOCOTECO II website.</p>
                        </div>
                    </div>
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h4 class="text-primary">General Manager</h4>
                                            <h5>[General Manager Name]</h5>
                                            <p class="text-muted">Overall management and strategic direction</p>
                                            <p><strong>Experience:</strong> [Years] years in electric cooperative management</p>
                                            <p><strong>Education:</strong> [Educational Background]</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h4 class="text-success">Assistant General Manager</h4>
                                            <h5>[AGM Name]</h5>
                                            <p class="text-muted">Operations and administrative support</p>
                                            <p><strong>Experience:</strong> [Years] years in utility operations</p>
                                            <p><strong>Education:</strong> [Educational Background]</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h4 class="text-warning">Finance Manager</h4>
                                            <h5>[Finance Manager Name]</h5>
                                            <p class="text-muted">Financial planning and management</p>
                                            <p><strong>Experience:</strong> [Years] years in financial management</p>
                                            <p><strong>Education:</strong> [Educational Background]</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h4 class="text-info">Engineering Manager</h4>
                                            <h5>[Engineering Manager Name]</h5>
                                            <p class="text-muted">Technical operations and maintenance</p>
                                            <p><strong>Experience:</strong> [Years] years in electrical engineering</p>
                                            <p><strong>Education:</strong> [Educational Background]</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h4 class="text-danger">Customer Service Manager</h4>
                                            <h5>[CS Manager Name]</h5>
                                            <p class="text-muted">Customer relations and service delivery</p>
                                            <p><strong>Experience:</strong> [Years] years in customer service</p>
                                            <p><strong>Education:</strong> [Educational Background]</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h4 class="text-secondary">HR Manager</h4>
                                            <h5>[HR Manager Name]</h5>
                                            <p class="text-muted">Human resources and administration</p>
                                            <p><strong>Experience:</strong> [Years] years in human resources</p>
                                            <p><strong>Education:</strong> [Educational Background]</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="mb-0">Management Philosophy</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h5 class="text-primary">Leadership Principles</h5>
                                            <ul>
                                                <li>Servant leadership and community focus</li>
                                        ...
                                        <div class="col-md-6">
                                            <h5 class="text-primary">Commitment to Excellence</h5>
                                            <ul>
                                                <li>Professional development and training</li>
                                                <li>Best practices implementation</li>
                                                <li>Technology adoption and modernization</li>
